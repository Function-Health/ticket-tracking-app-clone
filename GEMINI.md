...
Instructions for Gemini CLI and Gemini Antigravity agents (including subagents) operating in this repository. Mirrors [AGENTS.md](./AGENTS.md) — keep both in sync if you edit one.
